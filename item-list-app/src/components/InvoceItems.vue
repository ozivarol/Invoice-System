<template>
    ...
    <div class="table-body">
          <InvoceList v-for="item in items" :key="items.id" :item="item"/>
          <button @click="AddInvoceItem" class="mt-4 add-item-button">
...
const AddInvoceItem = inject("AddInvoceItem")
